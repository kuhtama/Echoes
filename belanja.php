                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index.html" class="logo">
                            <h1 style="font-size: 50px; font-weight:bold; font-family:Arial, Helvetica, sans-serif; color:#c96;">Echoes</h1>
                        </a>
                    ...
                    <nav class="main-nav">
                        <ul class="menu sf-arrows" style="display: inline-flex; gap:30px; list-style: none; margin: 0; padding: 0;">
                            ...
                            <li>
                                <a href="category.html">Belanja</a>
                            </li>
                            <li>
                    ...
                    <div class="header-right">
                        ...
                        <div class="dropdown compare-dropdown">
                            <a href="#signin-modal" class="dropdown-toggle" role="button" data-toggle="modal" aria-haspopup="true" aria-expanded="false" data-display="static" title="Compare Products" aria-label="Compare Products">
                                <i class="icon-user"></i>
                            </a>
                        </div>
