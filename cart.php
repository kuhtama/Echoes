            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">keranja Belanja</a></li>
	                			...
	                			<table class="table table-cart table-mobile">
									...
									<tbody>
										<tr>
											<td class="product-col">
												<div class="product">
													<figure class="product-media">
														<a href="#">
															<img src="assets/images/products/images.jpeg" alt="Product image">
														</a>
													</figure>

													<h3 class="product-title">
														<a href="#">Baju perwira Jerman</a>
											...
											<td class="total-col">Rp 3.500.000</td>
	                						...
	                						<tr class="summary-shipping-row">
	                							<td>
	                								<div class="custom-control custom-radio">
														...
														<label for="standart-shipping">Diskon</label>
